...
# select a station based on latitude and longitude
inventory_temps = [x for x in inventory if x.element in ['TMIN','TMAX'] and
                   x.end >= 2024 and x.start < 1920]
#print(inventory_temps[:5])

"""
[Inventory(station='USC00010583', latitude=30.8839, longitude=-87.7853, element='TMAX', start=1915, end=2025), 
Inventory(station='USC00010583', latitude=30.8839, longitude=-87.7853, element='TMIN', start=1915, end=2025), 
Inventory(station='USC00011694', latitude=32.8158, longitude=-86.6044, element='TMAX', start=1893, end=2025), 
Inventory(station='USC00011694', latitude=32.8158, longitude=-86.6044, element='TMIN', start=1893, end=2025), 
Inventory(station='USC00012813', latitude=30.5467, longitude=-87.8808, element='TMAX', start=1917, end=2025)]
"""

# downton chicago, obtained via online map
latitude, longitude = 41.882, -87.629
inventory_temps.sort(key=lambda x: abs(latitude-x.latitude) + abs(longitude-x.longitude))
#print(inventory_temps[:5])

"""
[Inventory(station='USC00110338', latitude=41.7803, longitude=-88.3092, element='TMAX', start=1893, end=2025),
Inventory(station='USC00110338', latitude=41.7803, longitude=-88.3092, element='TMIN', start=1893, end=2025),
Inventory(station='USC00112736', latitude=42.0628, longitude=-88.2861, element='TMAX', start=1897, end=2025),
